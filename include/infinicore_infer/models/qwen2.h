#ifndef MODEL_QWEN_2_H
#define MODEL_QWEN_2_H
...
createQwen2Weights(const Qwen2Meta *,
...
__C __export struct Qwen2Model *
createQwen2Model(const Qwen2Meta *,
                 const ModelWeights *);

/// @brief 销毁模型
__C __export void
destroyQwen2Model(struct Qwen2Model *);
...
__C __export void
inferBatchQwen2(struct Qwen2Model *,
