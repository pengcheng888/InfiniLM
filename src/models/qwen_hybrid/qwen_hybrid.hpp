...
struct QwenHybridDeviceWeight {
    ...
    //                                       moe                               //
    // ----------------------------------------------------------------------- //
    std::vector<std::shared_ptr<Tensor>> w_shared_expert_gate; // 共享专家gata
    std::vector<std::shared_ptr<Tensor>> w_router_expert_gate; // 路由专家gata
    ...
    std::vector<std::vector<std::shared_ptr<Tensor>>> w_router_expert_ffn_up;   // 路由专家的权重
